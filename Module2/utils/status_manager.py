...
class StatusManager:
    def __init__(self):
        ...
        # CRITICAL FIX: Ready posts are written to the tasks bucket, not structuredb
            ...
            try:
                ...
                if len(key_parts) >= 4:
                    ...
                    try:
                        ...
                        # Accept both legacy and current naming conventions
                        ready_posts = [
                            o for o in output_objects 
                            if ("campaign_ready_post_" in o["Key"]) or ("ready_post_" in o["Key"]) or (o["Key"].endswith(".jpg") and "/ready_post/" in o["Key"]) or (o["Key"].endswith(".json") and "/ready_post/" in o["Key"]) 
                        ]
