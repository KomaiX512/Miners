                ...
                if rag_content and len(rag_content) > 50:
                    ...
                    for competitor_username in secondary_usernames:
                        ...
                        enhanced_analysis[competitor_username] = {
                            ...
                            "recommended_counter_recommended_counter_strategies": competitor_insights.get("recommended_counter_strategies", []),
    ...
    def _extract_detailed_competitor_insights(self, rag_content, competitor_name):
        ...
        try:
            ...
            for sentence in competitor_sentences:
                ...
                if any(word in sentence_lower for word in ['vulnerability', 'weakness', 'opportunity', 'leverage', 'gap', 'improve', 'potential', 'can', 'should']):
                    competitor_insights["vulnerabilities"].append(sentence.strip()[:150])
                
                # Look for strategies and recommendations
                if any(word in sentence_lower for word in ['strategy', 'recommend', 'approach', 'focus', 'develop', 'implement', 'counter', 'position', 'against', 'versus', 'vs', 'compared to']):
            ...
            if not competitor_insights["recommended_counter_strategies"]:
                competitor_insights["recommended_counter_strategies"] = [f"Competitive positioning strategy vs {competitor_name}"]
