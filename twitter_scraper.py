...
class TwitterScraper:
    ...
    def extract_short_profile_info(self, profile_data, original_username=None):
        ...
        try:
            ...
            if not profile_data:
                ...
                return self._create_default_profile_info(original_username or "unknown_user")
            ...
            profile_info = {
                'username': screen_name or original_username or 'unknown_user',
                'name': full_name or screen_name or (original_username or 'Unknown User'),
                'bio': bio or '',
                'website': website or '',
    ...
    def process_account_batch(self, parent_username, competitor_usernames, results_limit=10, info_metadata=None):
        ...
        parent_short_info = self.extract_short_profile_info(parent_data, parent_username)
        ...
        for i, competitor in enumerate(competitor_usernames[:5]):  # Limit to 5 competitors
            ...
            try:
                ...
                competitor_short_info = self.extract_short_profile_info(competitor_data, competitor)
    ...
    def scrape_and_upload(self, username, results_limit=10, info_metadata=None):
        ...
        profile_info = self.extract_short_profile_info(profile_data, username)
